...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registrar novo usuário via email e senha' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Autenticar usuário e iniciar sessão' }),
    __param(0, (0, common_1.Body)()),
...
__decorate([
    (0, common_1.Get)('me'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Obter dados da sessão atual' }),
